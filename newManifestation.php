<?php
	...
	else
	{
		...
		function checkReservation($lieuID, $manifDate, $reservStart, $reservEnd, $recurenceID, $endRecurence)
		{
			$reservs = array();
		...
		if($_POST['manifDate']!=-1)
		{
			if($_POST['lieuID']!=-1)
			{
				checkReservation($_POST['lieuID'], $_POST['manifDate'], $_POST['reservStart'], $_POST['reservEnd'], $_POST['recurenceID'], $_POST['endRecurence']);
			}
			addManifestationReservation($manifID, $_POST['lieuID'], $_POST['manifDate'], $_POST['manifStart'], $_POST['manifEnd'], $_POST['reservStart'], $_POST['reservEnd'], $_POST['recurenceID'], $_POST['endRecurence']);
		}
		print($manifID);
	}
?>
