...
INSERT INTO `datesManif` VALUES (53,5,201604150800,201604150930),(56,7,201604150930,201604151030),(57,8,201604151030,201604151130),(58,9,201604151130,201604151230),(60,11,201609201400,201609201600),(62,10,201606072000,201606072200),(63,12,201610111330,201610111400),(68,34,201610200800,201610202200);
/*!40000 ALTER TABLE `datesManif` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `datesManif_save`
--

DROP TABLE IF EXISTS `datesManif_save`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `datesManif_save` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `manifestation_ID` bigint(20) NOT NULL,
  `debut_manif` bigint(20) NOT NULL,
  `fin_manif` bigint(20) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `manifestation_ID` (`manifestation_ID`),
  CONSTRAINT `datesManif_save_ibfk_1` FOREIGN KEY (`manifestation_ID`) REFERENCES `manifestation_save` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `datesManif_save`
--

LOCK TABLES `datesManif_save` WRITE;
/*!40000 ALTER TABLE `datesManif_save` DISABLE KEYS */;
INSERT INTO `datesManif_save` VALUES (53,5,201604150800,201604150930),(56,7,201604150930,201604151030),(57,8,201604151030,201604151130),(58,9,201604151130,201604151230),(60,11,201609201400,201609201600),(62,10,201606072000,201606072200),(63,12,201610111330,201610111400);
/*!40000 ALTER TABLE `datesManif_save` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `manifestation` VALUES (5,1,-1,-1,-1,1,1,'Test','marc.boilloux@bpi.fr',NULL,NULL),(6,1,-1,-1,-1,1,1,'','marc.boilloux@bpi.fr',NULL,NULL),(7,1,-1,-1,-1,1,1,'Test2','marc.boilloux@bpi.fr',NULL,NULL),(8,1,-1,-1,-1,1,1,'Test3','marc.boilloux@bpi.fr',NULL,NULL),(9,1,-1,-1,-1,1,1,'Test 4','marc.boilloux@bpi.fr',NULL,NULL),(10,1,-1,-1,-1,1,1,'Corps filmés','marc.boilloux@bpi.fr',NULL,NULL),(11,1,-1,-1,-1,1,1,'Mardi de l\'info : risques psychosociaux','marc.boilloux@bpi.fr',NULL,NULL),(12,1,-1,-1,-1,1,2,'Café des nouveaux arrivants','marc.boilloux@bpi.fr',NULL,NULL),(34,1,-1,-1,-1,1,2,'TSTaaaaa','arthur.covanov@bpi.fr','PRIVÉ!!!sasa','PRIVÉ!!!sasa');
/*!40000 ALTER TABLE `manifestation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `manifestation_save`
--

DROP TABLE IF EXISTS `manifestation_save`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `manifestation_save` (
  ...
  CONSTRAINT `manifestation_save_ibfk_1` FOREIGN KEY (`status_manifestation_ID`) REFERENCES `status_manifestation` (`ID`),
  CONSTRAINT `manifestation_save_ibfk_2` FOREIGN KEY (`type_manifestation_ID`) REFERENCES `type_manifestation` (`ID`),
  CONSTRAINT `manifestation_save_ibfk_3` FOREIGN KEY (`recurrence_manifestation_ID`) REFERENCES `recurrence_manifestation` (`ID`),
  CONSTRAINT `manifestation_save_ibfk_4` FOREIGN KEY (`responsable_ID`) REFERENCES `responsable` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `manifestation_save`
--

LOCK TABLES `manifestation_save` WRITE;
/*!40000 ALTER TABLE `manifestation_save` DISABLE KEYS */;
INSERT INTO `manifestation_save` VALUES (5,1,-1,-1,-1,1,1,'Test',13,NULL,NULL),(6,1,-1,-1,-1,1,1,'',13,NULL,NULL),(7,1,-1,-1,-1,1,1,'Test2',13,NULL,NULL),(8,1,-1,-1,-1,1,1,'Test3',13,NULL,NULL),(9,1,-1,-1,-1,1,1,'Test 4',13,NULL,NULL),(10,1,-1,-1,-1,1,1,'Corps filmés',13,NULL,NULL),(11,1,-1,-1,-1,1,1,'Mardi de l\'info : risques psychosociaux',13,NULL,NULL),(12,1,-1,-1,-1,1,2,'Café des nouveaux arrivants',13,NULL,NULL);
/*!40000 ALTER TABLE `manifestation_save` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `reservation_SAVE`
--

DROP TABLE IF EXISTS `reservation_SAVE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reservation_SAVE` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `lieu_ID` bigint(20) NOT NULL,
  `dates_manifestation_ID` bigint(20) NOT NULL,
  `debut_reservation` bigint(20) NOT NULL,
  ...
  KEY `lieu_ID` (`lieu_ID`),
  KEY `dates_manifestation_ID` (`dates_manifestation_ID`),
  CONSTRAINT `reservation_SAVE_ibfk_1` FOREIGN KEY (`lieu_ID`) REFERENCES `lieu` (`ID`),
  CONSTRAINT `reservation_SAVE_ibfk_2` FOREIGN KEY (`dates_manifestation_ID`) REFERENCES `datesManif_save` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `reservation_SAVE`
--

LOCK TABLES `reservation_SAVE` WRITE;
/*!40000 ALTER TABLE `reservation_SAVE` DISABLE KEYS */;
INSERT INTO `reservation_SAVE` VALUES (51,39,53,201604150800,201604150930),(53,39,56,201604150930,201604151030),(54,39,57,201604151030,201604151130),(55,39,58,201604151130,201604151230),(57,56,60,201609201400,201609201600),(58,22,63,201610111330,201610111400);
/*!40000 ALTER TABLE `reservation_SAVE` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-10-24 13:49:01
